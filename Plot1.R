# Coursera - Exploratory Data Analysis - Plot1.R
...
# 1st Figure is a histogram
png(file="plot1.png", width=picwidth, height=picheight) # set pixel width and height
hist(reduced_dat$Global_active_power, col='red', main='Global Active Power', 
