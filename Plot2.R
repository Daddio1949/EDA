# Coursera - Exploratory Data Analysis - Plot2.R
...
# 2nd Figure
png(file="plot2.png", width=picwidth, height=picheight) # set pixel width and height
plot( reduced_dat$Date_time , reduced_dat$Global_active_power,  type = "l", main='Plot 2',
      xlab='', ylab = 'Global Active Power (in kilowatt)' )
