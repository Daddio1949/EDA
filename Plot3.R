# Coursera - Exploratory Data Analysis - Plot3.R
...
#  3rd Figure
png(file="plot3.png", width=picwidth, height=picheight) # set pixel width and height
with( reduced_dat, plot( Date_time, Sub_metering_1 , type = "l", main='Plot 3', col='black', ylab='Sub Metering') )
